...
Triangle order_triangle (const Triangle t) {
	Point a;
	Point b;
	Point c;
...
Triangle build_bttm_flat_triangle (const Triangle t) {
	Triangle tt;
	...
	tt.g1 = get_gradient(t.a.color, t.b.color, t.a.y, t.b.y);
	tt.g2 = get_gradient(t.a.color, t.c.color, t.a.y, t.c.y);
		
	tt.slope_1 = slope (t.a, t.b);
	tt.slope_2 = slope (t.a, t.c);
	
	tt.z_value = t.z_value;
	
	tt = order_triangle_bttm_flat_x (tt);
	
	return tt;
}

Triangle build_top_flat_triangle (const Triangle t) {
	Triangle tt;
	...
	tt.g1 = get_gradient(t.a.color, t.c.color, t.a.y, t.c.y),
	tt.g2 = get_gradient(t.b.color, t.c.color, t.b.y, t.c.y),
		
	tt.slope_1 = slope (t.a, t.c);
	tt.slope_2 = slope (t.b, t.c);
	
	tt.z_value = t.z_value;
	
	tt = order_triangle_top_flat_x (tt);
...
void rasterize_bttm_flat_triangle (global unsigned char *A,
  ...
  *     \/
  */
void rasterize_top_flat_triangle (global unsigned char *A, global float* Z, const Triangle t, const Size size) {								 	 
...
void split_triangle (const Triangle t, global unsigned char *A, global float* Z, const Size size) {	 			
...
Triangle extract_triangle (global unsigned* T, 
													 global unsigned char* C,
													 global float* z) {
