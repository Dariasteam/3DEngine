...
void drawLine (Vertex2 v1, Vertex2 v2, std::vector<std::vector<Color888> >* screen_buffer) {
...
void RasteriserWireframe::rasterize_triangle(Triangle2& triangle, std::vector<std::vector<Color888> >* screen_buffer) {
